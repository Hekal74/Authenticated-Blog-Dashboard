...
const ValensBot: React.FC = () => {
  const [isOpen, setIsOpen] = useState<boolean>(false);
  const chatWindowRef = useRef<HTMLDivElement | null>(null);
  const botUrl: string = "https://bot-provider.wordworksai.me/?id=valensclinic";
  ...
  return (
    <div className="fixed bottom-[168px] right-6 z-50 flex flex-col items-end">
      {/* Chat Window */}
      {isOpen && (
        <div
          ref={chatWindowRef}
