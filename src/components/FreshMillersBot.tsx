...
const FreshMillersBot: React.FC = () => {
  const [isOpen, setIsOpen] = useState<boolean>(false);
  const chatWindowRef = useRef<HTMLDivElement | null>(null);
  const botUrl: string = "https://bot-provider.wordworksai.me/?id=fresh-millers";
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="bg-blue-600 text-white p-3 flex justify-between items-center">
            <h3 className="font-medium">Fresh Millers </h3>
            <button
...
export default FreshMillersBot;